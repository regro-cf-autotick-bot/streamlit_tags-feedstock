...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/streamlit_tags-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12986&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/streamlit_tags-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `streamlit_tags` can be installed with:

```
conda install streamlit_tags
```

It is possible to list all of the versions of `streamlit_tags` available on your platform with:
